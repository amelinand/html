...
function totalMenAndWoman($data){
  $maxMan = 0;
  $maxWomen = 0;
  ...
  echo(" Le nombre total de femme est ". $maxWomen. "<br>");
  echo(" Le nombre total d'homme est ". $maxMan. "<br>");
}
...
function average($data){
  ...
  echo(" L'age moyen des femmes est ". $middleWomen. "<br>");
  echo(" L'age moyen des hommes est ". $middleMan. "<br>");
}

totalMenAndWoman($titanicData);
average($titanicData);



/* Calculer les données suivantes :
 * - Le nombre total de femmes et celui d'hommes
 * - La moyenne d'âge des femmes et celle des hommes
 */


/*
 * Ensuite :
 *  - Le nombre total de femmes qui ont survécu (Pareil avec les hommes)
 *  - Le nombre total de femmes qui n'ont pas survécu (Pareil avec les hommes)
...
/* Enfin :
 *  - Le/les nom de/s plus jeune/s et le/les plus âgé/s des personnes qui ont survécu
 *  - Le/les nom de/s plus jeune/s et le/les plus âgé/s des personnes qui n'ont pas survécu
 */


/* On s'arrete plus :
 *  - Le nombre de personnes qui ont la 20 aine, 30 aine, 40aine, 50aine, 60aine, 70aine, 80aine. (age)
 *  - Le nombre de personnes mineur (18 ans)
 *
 *
 *  // Notes :
 *      - Vous pouvez tout faire dans un seul foreach (Si vous vous perdez, faites un/une foreach/function
 *        pour chaque calcul et ensuite essayez de regrouper le tout dans un seul)
 *      - Essayer differentes conditions (if, elseif, switch, ...) et utilisez celle que vous trouvez la plus
 *        adapté. (Il n'y a pas de bonne ou de mauvaise solution, certaines sont juste plus adéquate)
 */
